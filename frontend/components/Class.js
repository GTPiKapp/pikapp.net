				...
				<Col xs={24} sm={20} md={14}>
					<Row type="flex" align="top" justify="space-around" style={{marginBottom: 20}}>
						...
						<Col sm={24} md={12} lg={7}>
							<Card style={{textAlign: 'center'}}>
								<h2>Academics</h2>
								<p>Pi Kapps strive to attain the highset possible standards of scholarship.</p>
							</Card>
						</Col>
						...
						<Col sm={24} md={12} lg={7}>
							<Card style={{textAlign: 'center'}}>
								<h2>Sportsmanship</h2>
								<p>Pi Kapps ensure our behavior and treatment of others both in a sporting environment and our general coduct is exemplary.</p>
							</Card>
						</Col>
						<Col sm={24} md={12} lg={7}>
							<Card style={{textAlign: 'center'}}>
