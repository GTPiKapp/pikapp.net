				...
				<Col md={14} xs={24} sm={20}>
					<Row type="flex" justify="space-around" style={{paddingTop: 20}}>
						<Card style={{width: '100%'}}>
							...
							Rush will take place from <b>Tuesday, January 16th</b> through <b>Friday, January 19th</b>. Rush officially starts at <b>7pm</b> and ends at <b>11pm</b> each day. You can visit our house (white house across from the baseball field) anytime you like, and feel free to email our <a href="/officers" title="Officers">Vice President Ryan</a> for questions at any time!</p>
