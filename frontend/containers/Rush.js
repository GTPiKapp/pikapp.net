					...
					<Row
						...
						<Card style={{ width: '100%' }}>
							...
							<p>
								<b>Formal Rush</b>
								<br />
								At the beginning of each semester, IFC sponsors
								a week called Rush that is designed to be a fun
								and easy way for you to become familiar with the
								fraternity and brothers of Pi Kappa Phi. Rush is
								very informal and relaxed, requires no
								registration, and carries no financial
								commitment or obligation to join. Every
								academically eligible man at Georgia Tech can
								participate regardless of age or year in school.
							</p>
							<p>
								During the nights of rush, Pi Kapp will hold an
								open house where you can come eat dinner, meet
								...
								different days and meet different brothers. The
								best way to get a feel for what a fraternity is
								like is by meeting as many of the brothers as
								possible.
							</p>
							<p>
								<b>Receiving a Bid</b>
								...
								first few nights. Also, do not be afraid to ask
								each chapter how their bid process works and if
								you are the kind of member they are looking for.
							</p>
							<p>
								<b>FAQs</b>
								<br />
								<i>
									Do I have to become a brother if I accept my
									bid?
								</i>
								<br />
							...
							<p>
								...
								<br />
								While you are expected to become involved and
							...
							<p>
								...
								<br />
								Rush is very informal, so wear whatever you feel
								comfortable in. Most chapters will be dressed in
								business casual — a collared shirt and khakis,
								but you aren’t expected to wear anything
								special.
							</p>
							<p>
								...
								<a
									...
									title="Email our Vice President">
									vicepresident@pikapp.net
								</a>{' '}
								or{' '}
