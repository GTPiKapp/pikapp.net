					...
					<Row type="flex" justify="space-around" style={{paddingTop: 20}}>
						<Col sm={24} md={24} lg={17}>
							<Card style={{width: '100%'}}>
								...
								<p>We're extremely lucky to have a very dedicated house manager who ensures that our house always looks as beautiful as the day we moved in. Jonah Brown, our esteemed house manager, always ensures that we have a clean house to come home to.</p>
							</Card>
						</Col>
						<Col sm={12} lg={6}>
							<Card style={{width: '100%'}}>
								<Image src="virginia-moore.jpg" title="Virginia Moore" caption="Jonah Brown, House Manager" />
							</Card>
						</Col>
					</Row>
					<Row type="flex" justify="space-around" style={{paddingTop: 20}}>
