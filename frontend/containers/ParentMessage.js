				...
				<Col xs={24} sm={20} md={14}>
					<Row type="flex" justify="space-around" style={{paddingTop: 20}}>
						<Card style={{width: '100%'}}>
							...
							<p>Feel free to contact me or any of the <a href="/about/officers" title="Pi Kappa Phi Officers">officers</a> for any questions you may have about Pi Kappa Phi or fraternity life in general and the college experience.</p>
							<p>Best Regards,</p>
							<p>Vishnu Rajendran<br/>
							President<br/>
							Iota Chapter<br/>
